...
import { getUserDocument, googleLogin, postUserDocument } from "@/services/firebase";
...
function LoginButton(props: LoginButtonProps) {
  ...
  async function handleSignIn() {
    ...
    if (!isExistUser) {
      ...
      const newUser = generateUserObject(uid, email!, displayName || email!, createdAt);
...
function generateUserObject(uid: string, email: string, displayName: string, createdAt: number) {
